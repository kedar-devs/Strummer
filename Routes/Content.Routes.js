...
routes.get('/video/AddLike/:id',CommentController.AddLike)
routes.get('/video/RemoveLike/:id',CommentController.RemoveLike)
routes.get('/video/AddDislike/:id',CommentController.AddDislike)
routes.get('/video/RemoveDisLike/:id',CommentController.RemoveDisLike)
routes.get('/video/IncreaseReply',CommentController.IncreaseCount)
