...
const LikeCountController=require('./../Controller/LikeController')
const DislikeController=require('./../Controller/DisLike.controller')

routes.post("/NewContent",ContentController.CreateNewContent)
routes.post("/AddLike/:id",ContentController.AddLikeFunctionality)
routes.get("/AddLike/:id",ContentController.AddLikes)
routes.post("/RemoveLike/:id",ContentController.RemoveLikesFunction)
routes.get("/RemoveLike/:id",ContentController.RemoveLikes)
routes.post('/AddDislikes/:id',ContentController.AddDislikeFunctionality)
routes.get("/AddDislikes/:id",ContentController.AddDislike)
routes.post('/RemoveDisLike/:id',ContentController.RemoveDislikeFunction)
...
routes.post("/Likes/AddLikes",LikeCountController.AddLikes)
routes.post('/Dislikes/Adddislikes',DislikeController.AddDisLikes)
routes.put('/Likes/checkLikes',ContentController.checkLikeFunction) 
routes.put('/Dislikes/checkLikes',ContentController.checkDisLikeFunction) 
routes.delete('/Likes/DeleteLikes',LikeCountController.deleteLikes)
routes.delete('/Dislikes/DeleteDislikes',DislikeController.deleteDisLikes)

routes.get('/likes/getLikedVideos/:id',ContentController.getLikedVideo)
